  ...
  return (
    <header className="bg-white shadow-md">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="space-x-16 font-['poppins']">
          ...
          <a href="/projects" className="text-gray-600 hover:text-gray-900">Courses</a>
          <a href="/projects" className="text-gray-600 hover:text-gray-900">Blog</a>
          <a href="/projects" className="text-gray-600 hover:text-gray-900">Contact</a>
        </nav>
        <div className="gap-4 flex items-center justify-center">
          <a href="/signin" className="font-normal text-[14px] text-[#0148b7] border border-[#0148b7] rounded-[25px] px-4 py-2 hover:bg-blue-600 hover:text-white">Parent Helpdesk</a>
