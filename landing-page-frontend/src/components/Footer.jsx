    ...
    return (
        <div>
            <footer class="bg-white dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8 font-['poppins'] flex flex-col items-center">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <div className="text-lg font-medium"> 
                                    ...
                                    <span className="text-purple-600">Realm</span> 
                                </div>
                            </div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        &copy; Copyright 2023 Focus Realm. All rights reserved.
                    </p>
                </div>
            </footer>
        </div>
